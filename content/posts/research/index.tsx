            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    The Motivation, Calibration, and Simulation of IRIS: Intense Radiation Integration Sensor
                  </a>
              ...
              <li>
                  ...
                  rel="noopener noreferrer"
                  >
                    A Novel, Low-Cost Approach to Direct Measurement of Radiation Dose Associated with Terrestrial Gamma Ray Flashes
                  </a>
      ...
      <Card>
        ...
        <CardFooter className="flex flex-col items-start gap-4">
          <div>
            ...
            replication. We still managed to get CT curves from our unintentionally
            destructive experiment.
            <p></p>
            <div className="w-full flex justify-center">
              <a href="/internshipPapers/csusb/CrestPoster2018.pdf" target="_blank" rel="noopener noreferrer">
                View Poster
              </a>
            </div>
          </div>
